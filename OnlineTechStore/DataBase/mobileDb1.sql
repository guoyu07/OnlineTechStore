...
(16, 'preethi@yahoo.com', 8, 'Laptops Bike', 260);
...
INSERT INTO `gadgets` (`itemid`, `itemname`, `categoryId`, `itemdesc`, `price`, `image`, `Gender`, `quantity`) VALUES
(1, 'iphone 5', 1, 'mobile ', 75, 'quo.jpg', 'Girl', 9),
(2, 'iphone 6', 1, 'iphone 6', 50, 'quo.jpg', 'Girl', 9),
(3, 'ipad', 1, 'Using Colors for drawing..', 40, 'quo.jpg', 'Girl', 9),
...
(6, 'Laptops Cycle', 2, 'Cycle for Laptops girls', 260, 'images/bcycle.jpg', 'Girl', 10),
(7, 'Butterfly Laptops', 2, 'Butterfly Laptops girls', 260, 'images/bfly.jpg', 'Girl', 10),
(8, 'Laptops Bike', 2, 'Bike for Laptops girls', 260, 'images/bgirlbike.jpg', 'Girl', 9),
(9, 'Laptops Kids', 2, 'Laptops for kids play', 260, 'images/bkids.jpg', 'Girl', 10),
(10, 'Pink Laptops Princess', 2, 'Pink Princess', 200, 'images/bpink.jpg', 'Girl', 10),
...
(18, 'Cameras House', 4, 'Manage to create a house of your imagination', 150, 'images/house.jpg', 'Girl', 10),
...
(22, 'Building block-Castle', 4, 'Want a castle of Cameras', 150, 'images/castle.jpg', 'Girl', 10),
...
(31, 'Learn Body parts Musical Toy', 6, 'Learn the different body parts', 98, 'images/Body.jpg', 'Girl', 10),
(32, 'Learning clock', 6, 'Whats the time now', 98, 'images/clock.jpg', 'Boy', 10),
(33, 'match-Music', 6, 'Match the shapes and fill in', 98, 'images/match.jpg', 'Boy', 10),
(34, 'puzzle-Music', 6, 'Create a animal by joining the puzzle pieces', 98, 'images/puzzle.jpg', 'Girl', 10),
...
(71, 'Laptops-doll', 9, 'Princess Laptops for baby girls', 40, 'images/Laptops-doll.jpg', 'Girl', 0),
